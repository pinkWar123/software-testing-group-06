...
- [x] Report all genuine API 3 bugs in Markdown and GitHub Issues, with execution evidence. (`API3-035` → [GitHub Issue #77](https://github.com/pinkWar123/software-testing-group-06/issues/77); newly confirmed `API3-011` is documented in report §9.7 but its GitHub Issue is pending.)
...
- [x] Write the CI/CD report describing the configuration and both required runs. (Report §12 documents the workflow, full-regression quality gate, passing smoke run [32545873635](https://github.com/pinkWar123/software-testing-group-06/actions/runs/32545873635), and controlled one-failure run [32545875356](https://github.com/pinkWar123/software-testing-group-06/actions/runs/32545875356).)
...
- [x] Add screenshots and links for both CI/CD runs. (Passing-run screenshot: `artifacts/evidence/ci/01_ci_smoke_pass.png` with [run 32545873635](https://github.com/pinkWar123/software-testing-group-06/actions/runs/32545873635); controlled-failure screenshot: `artifacts/evidence/ci/02_ci_controlled_failure.png` with [run 32545875356](https://github.com/pinkWar123/software-testing-group-06/actions/runs/32545875356).)
